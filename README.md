...
The linked list implementation builds as a dynamic and static library by default. In order to trigger the build, simply call the Makefile at the root of the project using `make`.
